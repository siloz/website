...
function popup_show(id, drag_id, exit_id, position, x, y, position_id)
{
  ...
  {
    element.style.left = (document.body.scrollLeft + document.documentElement.scrollLeft+(width -element.clientWidth )/2+x)+'px';
    element.style.top  = (document.body.scrollTop +document.documentElement.scrollTop +(height-element.clientHeight)/2+y)+'px';
  }
