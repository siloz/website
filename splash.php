...
<div id="footer_container" class="row">
	<div id="quick_start_bg">
		...
		<div id="bottom_menu">
			<a href="index.php?task=contact_us">contact <?=SITE_NAME?></a> | <a href="index.php?task=about_us">about</a> | <a href="index.php?task=tos">terms of use</a> | <a href="index.php#quick-start">get started!</a> | <a href="index.php?task=faq">faq</a> | <a href="index.php?task=stories"><?=SITE_NAME?> stories</a>
		</div>
	</div>
</div>
