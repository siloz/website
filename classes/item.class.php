...
class Item {
	...
	function getPlate() {		
		...
		$cell .= "<div style='margin-top: 5px; height: 15px'><img height=100px width=135px src=uploads/items/".$this->photo_file_1." style='margin-bottom: 3px'></div><div style='margin-bottom: 3px'><a href='index.php?task=view_item&id=".$this->id."'><b>".$this->getShortTitle(40)."</b></a><span style='color: #f60'><b>$".$this->price."</b></span></div></a></div>";
