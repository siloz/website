...
<table id="radar_table">
	...
	<?php 
		...
		$url_user = (
			"<a href='http://stage.james.siloz.com/website/index.php?task=view_user&id=".$User->id."' "
		...
		$url_silo = (
			"<a href='http://stage.james.siloz.com/website/index.php?task=view_silo&id=".$Silo->id."' "
		...
		$url_mailto = (
			...
			.$User->email
			."?subject="
			."IMPOTANT: NOTICE FROM SILOZ.com"
			."'>"
			.$User->email
			."</a>"
		);
