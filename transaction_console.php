...
while ($item = mysql_fetch_array($qry)) {
	...
	elseif ($status == "requested") { $cStatus = "Silo requested"; $notif = "Awaiting silo creation from administrator"; $contact = "Pending silo administator"; $actions = "<a onclick=\"popup_show('editItem_".$item_id."', 'editItem_".$item_id."_drag', 'editItem_".$item_id."_exit', 'screen-center', 0, 0);\">Edit Item</a> | <a onclick=\"popup_show('delItem_".$item_id."', 'delItem_".$item_id."_drag', 'delItem_".$item_id."_exit', 'screen-center', 0, 0);\">Delete Item</a>"; }
...
while ($item = mysql_fetch_array($qry)) {
	...
	elseif ($offer) {
		...
		if ($status == "pending") { $cStatus = "You made an offer of $".$amount."."; $notif = "Seller has until ".$exp." to accept this offer or it will expire."; $contact = "No other party at this time"; $actions = "<a onclick=\"popup_show('buy-notif_".$item_id."', 'buy-notif_".$item_id."_drag', 'buy-notif_".$item_id."_exit', 'screen-center', 0, 0);\">Buy</a> | <a onclick=\"popup_show('cancelOffer_".$item_id."', 'cancelOffer_".$item_id."_drag', 'cancelOffer_".$item_id."_exit', 'screen-center', 0, 0);\">Cancel Offer</a>"; }
		...
		elseif ($status == "declined") { $cStatus = "Watching (your $".$amount." offer was declined)"; $notif = "No notifications"; $contact = "No other party at this time"; $actions = "<a onclick=\"popup_show('buy-notif_".$item_id."', 'buy-notif_".$item_id."_drag', 'buy-notif_".$item_id."_exit', 'screen-center', 0, 0);\">Buy</a> | <a onclick=\"popup_show('rmFav_".$item_id."', 'rmFav_".$item_id."_drag', 'rmFav_".$item_id."_exit', 'screen-center', 0, 0);\">Clear Item</a>"; }
	} 
		...
		if ($addInfo_full) {
			...
			$actions = "<a onclick=\"popup_show('buy-notif_".$item_id."', 'buy-notif_".$item_id."_drag', 'buy-notif_".$item_id."_exit', 'screen-center', 0, 0);\">Buy</a> | <a onclick=\"popup_show('rmFav_".$item_id."', 'rmFav_".$item_id."_drag', 'rmFav_".$item_id."_exit', 'screen-center', 0, 0);\">Clear Item</a> | <a onclick=\"popup_show('mkOffer_".$item_id."', 'mkOffer_".$item_id."_drag', 'mkOffer_".$item_id."_exit', 'screen-center', 0, 0);\">Make Offer</a>"; 
		}
	}
?>
